...
/**
 * Implementation of JHttpTransportCurl class from Joomla, with some modifications
 */
class HttpTransportCurl
{
    /**
     * @var    RegistrableInterface  The client options.
     * @since  11.3
     */
    protected $options;
     ...
     *
     * @param   RegistrableInterface  $options  Client options object.
     *
     * @see     http://www.php.net/manual/en/function.curl-setopt.php
     * @since   11.3
     * @throws  Exception
     */
    public function __construct(RegistrableInterface $options)
    {
        if (!function_exists('curl_init') || !is_callable('curl_init'))
        {
            throw new Exception('Cannot use a cURL transport when curl_init() is not available.');
        }
    ...
    public function request($method, $uri, $data = null, array $headers = null, $timeout = null, $userAgent = null)
    {
        ...
        if (!is_string($content))
        {
            ...
            Factory::getContainer()->log->error($message);
